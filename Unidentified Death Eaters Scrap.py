...
root_url = ('http://harrypotter.wikia.com/wiki/Category:Unidentified_Death_Eaters')

import requests 
Unidentified_Death_Eaters = requests.get ("http://harrypotter.wikia.com/wiki/Category:Unidentified_Death_Eaters")
if Unidentified_Death_Eaters.status_code != 200:


    print ("There was an error with", url)

page_html = Unidentified_Death_Eaters.text
