...
root_url = 'http://harrypotter.wikia.com/wiki/Category:Unnamed_family_members'

import requests
Unnamed_family_members = requests.get("http://harrypotter.wikia.com/wiki/Category:Unnamed_family_members")

if Unnamed_family_members.status_code != 200:    
    print ("There was an error with", url)

page_html = Unnamed_family_members.text
